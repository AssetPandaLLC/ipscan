...
public class InetAddressUtilsTest {
	...
	public void findHostnames() throws Exception {
		Matcher matcher = InetAddressUtils.HOSTNAME_REGEX.matcher("Asset Panda IP Scanner's official site is https://angryip.org, not http://www.angryziber.com. Isn't it cool?");
		assertTrue(matcher.find());
